...
void AlaLed::setAnimation(int animation, long speed,int numLeds)
{
...
void AlaLed::setAnimationFunc(int animation)
{
    switch(animation)
    {
		...
		//case ALA_LARSONSCANNERBOTH:     animFunc = &AlaLedRgb::larsonScanner_both; break;
		...
		//case ALA_SHINE:                 animFunc = &AlaLedRgb::shine;              break;
